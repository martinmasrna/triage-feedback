...
/**
 * Build a complete StoredCase from its parts: merges findings (doctor wins), runs the engine
 * on the effective findings, and stamps provenance. This is the single place a case is
 * composed, so `effective` and `decision` can never drift apart.
 */
